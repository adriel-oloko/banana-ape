    ...
    return (
        <div className="min-h-svh min-w-svw bg-[#2664dd] flex justify-center items-center p-16 relative">
            <div className="absolute inset-0 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="fill-white -translate-y-[35%] md:-translate-y-12 md:max-w-[560px]"><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/></svg>
                ...
                <div className="flex flex-col gap-2 p-0">
                    ...
                    <div className="rounded-2xl bg-[#1e1e28] p-4 grid grid-cols-2">
                        <div className="flex flex-col gap-1">
                            ...
                            <p className="font-medium text-sm md:font-semibold">$5/h</p>
                        </div>
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="w-full grid grid-cols-2">
                                <div className="border-r border-solid border-gray-50 py-0.5 flex items-center gap-2">
                                    ...
                                    <p className="text-sm font-medium md:font-semibold">80</p>
                                </div>
